...
### Must Complete
- [x] #36: Add source lifecycle management (create, git init, publish)
...
- [x] Can create new local source directories (Workflow 6)
- [x] Can initialize any source as a git repo (Workflow 7)
- [x] Can connect source to GitHub (new or existing repo) (Workflow 8)
- [x] Can push changes to remote (Workflow 9)
- [x] Config tracks git status per source (git.enabled, git.url in config.yaml)
- [x] Works with the "roster" mental model (voice examples use guild naming)
...
- [ ] Works with the "roster" mental model (my-source, data-ml-guild, etc.)
